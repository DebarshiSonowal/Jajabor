...
//        Picasso.get().load("https://firebasestorage.googleapis.com/v0/b/jajabor-android.appspot.com/o/banners%20for%20app-03.jpg?alt=media&token=36d7a59b-493a-4458-afac-7aad0c4801df").resize(1240,1240).into(offer);
        ...
        Glide.with(mContext)
                .load("https://firebasestorage.googleapis.com/v0/b/jajabor-android.appspot.com/o/banners%20for%20app-03.jpg?alt=media&token=36d7a59b-493a-4458-afac-7aad0c4801df")
                .error(R.drawable.error_404).dontAnimate()
                .into(offer);
        Glide.with(mContext)
                .load("https://firebasestorage.googleapis.com/v0/b/jajabor-android.appspot.com/o/banners%20for%20app-02.jpg?alt=media&token=f59a2969-34d4-4654-88b6-87a0ce2040e6")
                .error(R.drawable.error_404).dontAnimate()
                .into(mImageView);
        Glide.with(mContext)
                .load("https://firebasestorage.googleapis.com/v0/b/jajabor-android.appspot.com/o/banners%20for%20app-01.jpg?alt=media&token=aa67bdfd-4ea8-4637-8b2c-6f7457691c8c")
                .error(R.drawable.error_404).dontAnimate()
                .into(mImageView2);
...
//        price.add("₹299.00");
//        price.add("₹299.00");
        url1.add("https://images.bewakoof.com/uploads/grid/app/Men-s-Colorblock-1591361054.png");
        url1.add("https://images.bewakoof.com/uploads/grid/app/Men-s-Colorblock-1591361054.png");
        url1.add("https://images.bewakoof.com/uploads/grid/app/Men-s-Colorblock-1591361054.png");
        url1.add("https://images.bewakoof.com/uploads/grid/app/Women-s-34th-Sleeves--1--1591788297.png");
        url1.add("https://images.bewakoof.com/uploads/grid/app/Women-s-Crop-Tops--1--1591788298.png");
        url1.add("https://images.bewakoof.com/uploads/grid/app/Women-s-Crop-Tops--1--1591788298.png");
        name1.add("Mens Colorblock");
        name1.add("Mens Colorblock");
        name1.add("Men-s-Colorblock");
        name1.add("Womens 34th Sleeves");
        name1.add("Men-s-Colorblock");
        name1.add("Men-s-Colorblock");
